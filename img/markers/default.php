...
$output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . htmlspecialchars($_GET["search-input"]) . apply_filters( 'wpsl_search_input', '' ) . '" name="wpsl-search-input" placeholder="City, State or Zip" aria-required="true" />' . "\r\n";
$output .= "\t\t\t" . '</div>' . "\r\n";
