...
$output .= "\t\t\t\t" . '<div><label for="wpsl-search-input">Your location</label></div>' . "\r\n";
$output .= "\t\t\t\t" . '<input id="wpsl-search-input" type="text" value="' . htmlspecialchars($_GET["search-input"]) . '" name="wpsl-search-input" placeholder="Address or Zip" aria-required="true" />' . "\r\n";
$output .= "\t\t\t" . '</div>' . "\r\n";
...
if ( $wpsl_settings['radius_dropdown'] || $wpsl_settings['results_dropdown']  ) {
    ...
    if ( $wpsl_settings['radius_dropdown'] ) {
        ...
        $output .= "\t\t\t\t\t" . '<label for="wpsl-radius-dropdown">Search radius</label>' . "\r\n";
    ...
    if ( $wpsl_settings['results_dropdown'] ) {
        ...
        $output .= "\t\t\t\t\t" . '<label for="wpsl-results-dropdown">Number of results</label>' . "\r\n";
...
$output .= "\t\t\t\t" . '<div class="wpsl-search-btn-wrap"><input id="wpsl-search-btn" type="submit" value="Search"></div>' . "\r\n";
